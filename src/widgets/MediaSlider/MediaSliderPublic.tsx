...
import styles from "./MediaSliderPublic.module.css";
    ...
    return (
      <div className={styles.paginationImage}>
        {isVideo ? (
          ...
          /* Для изображений просто показываем миниатюру */
          <Image
            src={item.url}
      ...
      {pagination && processedMedia.length > 1 && (
        <div className={styles.pagination}>
          <Swiper
            ...
            speed={200}
            breakpoints={paginationBreakpoints}
            onSwiper={swiper => {
