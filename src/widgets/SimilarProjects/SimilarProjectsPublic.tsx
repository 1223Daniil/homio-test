...
import styles from "./SimilarProjectsPublic.module.css";
...
const SimilarProjectsPublic = ({ similarProjects }: IProps) => {
        ...
        {similarProjects.length > 0 && (
          <>
            <SliderControl
              direction="prev"
              onClick={handlePrev}
              className={`${styles.prevButton} ${styles.control}`}
            />
            <SliderControl
              direction="next"
              onClick={handleNext}
              className={`${styles.nextButton} ${styles.control}`}
            />
          </>
        )}
...
export default SimilarProjectsPublic;
