          ...
          {units.length > 0 ? (
            units.map(unit => {
              ...
              const imageUrl =
                ...
                (unit as any)?.layout?.images?.[0]?.url ||
                (unit as any)?.project?.media?.[0]?.url;
              ...
              const unitData = {
                ...
                area: (unit as any).layout?.totalArea || unit.area || 0,
                blurhash:
                  (unit as any)?.layout?.mainImage?.blurhash ||
                  (unit as any)?.layout?.images?.[0]?.blurhash ||
                  (unit as any)?.project?.media?.[0]?.blurhash
              };
